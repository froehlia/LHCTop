...
Als Jets bezeichnet man eine Gruppe von Hadronen, welche in die Richtung des Ursprungs-Quarks fliegen (siehe Hadronisierung). Wie jedes experimentell rekonstruierte Objekt m\"ussen auch Jets kallibriert werden. Die Kallibration der Jet Energie ber\"ucksichtigt Energiebeitr\"age aus weiteren proton-proton Kollisionen, die Response des Detektors und weitere Detektoreffekte. Zur Kalibrierung der Jet-Energie werden von der CMS-Gruppe Korrekturen bestimmt und von den verschiedenen Analysen angewendet.Die Jet Energie Korrekturen (JEC) sind f\"ur viele Analysen von gro\ss{}er Bedeutung und deren wichtigste systematische Unsicherheit.  
