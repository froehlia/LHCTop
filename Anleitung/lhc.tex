...
%\begin{figure}[htc]
%	\centering
%	\includegraphics[scale=0.55]{LHC/int_lumi_per_day_cumulative_pp_2012}
%	\caption[Zeitliche Entwicklung der integrierten Luminosit"at am LHC]{Zeitliche Entwicklung der integrierten Luminosit"at, die vom LHC (blau) geliefert und vom CMS-Detektor (orange) 2012 aufgenommen wurde \cite{lhclumi}.}
%	\label{intlumi}
%\end{figure}
\\
